CPPX
======
Trying to complete 125 projects in CPPX
...
**Bank Account Manager** \- Create a class called 'Accoun' which will be an abstract class for three other classes called 'CheckingAccoun', 'SavingsAccoun' and 'BusinessAccoun'. Manage credits and debits from these accounts through an ATM style program.
